export const translations = {
  ...
  ar: {
    ...
    seo: {
      ...
      homeDesc: "خدمات احترافية لجلي الرخام والبلاط والعمل بالمعدات وتنظيف الأرضيات في الرياض. خبرة أكثر من ١٠ سنوات. خدمة في نفس اليوم. مواد صديقة للبيئة. اتصل: ١٨٣٥ ١٩٢ ٥٠ ٩٦٦+",
      ...
      contactTitle: "تواصل معنا | جلي رخام وبلاط الرياض — اتصل أو واتساب +٩٦٦ ٥٠ ١٩٢ ١٨٣٥",
      contactDesc: "تواصل معنا لجلي الرخام وتلميع البلاط وترميم الأرضيات في الرياض. اتصل أو واتساب: ١٨٣٥ ١٩٢ ٥٠ ٩٦٦+. نخدم جميع أحياء الرياض.",
